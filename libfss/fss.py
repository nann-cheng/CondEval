...
class NewICKey(object):
    ...
    def unpack(cls,binary,ring_len):
        ...
        icKey.CW_1 = GroupElement.unpack(binary[bytes_amount_per_cw:bytes_amount_per_cw*2], ring_len)
...
class FlexKey(object):
    ...
    def unpack(cls,binary,ring_len):
        ...
        CW_payload = GroupElement.unpack(binary[1:bytes_amount_per_cw+1], FIX_OUTPUT_BITS_LEN)
